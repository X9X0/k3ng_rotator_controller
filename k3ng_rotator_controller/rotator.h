...
#define CONFIGURATION_STRUCT_VERSION 124
...
// Calibration return codes
#define CALIBRATION_SUCCESS 0
#define CALIBRATION_ERROR_LIMIT_HIT 1
#define CALIBRATION_ERROR_INCOMPLETE_ROTATION 2
#define CALIBRATION_ERROR_TIMEOUT 3
#define CALIBRATION_ERROR_NO_SENSOR 4
#define CALIBRATION_ERROR_INSUFFICIENT_DATA 5
#define CALIBRATION_PARTIAL_SUCCESS 6
#define CALIBRATION_IN_PROGRESS 7
#define CALIBRATION_QUALITY_GOOD 8
#define CALIBRATION_QUALITY_POOR 9
#define CALIBRATION_QUALITY_SUSPECT 10
#define CALIBRATION_ERROR_BUSY 11
#define CALIBRATION_ERROR_INSUFFICIENT_RANGE 12
#define CALIBRATION_ERROR_LIMIT_ALREADY_HIT 13
#define CALIBRATION_ERROR_INVALID_DATA 14
#define CALIBRATION_ERROR_NO_MOVEMENT 15
#define CALIBRATION_ERROR_OUT_OF_RANGE 16

// Magnetometer calibration states
#define MAG_CAL_IDLE 0
#define MAG_CAL_INIT 1
#define MAG_CAL_ROTATING 2
#define MAG_CAL_SAVING 3
#define MAG_CAL_COMPLETE 4
#define MAG_CAL_ERROR 5
#define MAG_CAL_ERROR_LIMIT_HIT 6
